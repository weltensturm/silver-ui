    ...
    :Alpha(0.9)
{
    ...
    [Script.OnEnter] = function(self)
        ...
        GameTooltip:SetUnitAura(self.unit, self.aura.index, self.aura.filter);
        GameTooltip:Show()
    end,
...
Addon.Units.Auras = Frame { Addon.Templates.AuraTracker } {
    ...
    Layout = function(self)
        for i=1, #self.buffs do
            self.buffs[i]:SetPoint('LEFT', self, 'RIGHT', (i-0.33)*14, 0)
        end
        for i=1, #self.debuffs do
            self.debuffs[i]:SetPoint('RIGHT', self, 'LEFT', -(i-0.33)*14, 0)
        end
    end,
    ...
    AddBuff = function(self, aura)
        ...
        frame:SetPoint('LEFT', self, 'RIGHT', (#self.buffs-0.33)*14, 0)
    end,
    ...
    AddDebuff = function(self, aura)
        ...
        frame:SetAura(self.unit, aura)
        frame:ClearAllPoints()
        frame:SetPoint('RIGHT', self, 'LEFT', -(#self.debuffs-0.33)*14, 0)
    end,
